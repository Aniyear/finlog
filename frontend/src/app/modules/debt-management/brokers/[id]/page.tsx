    ...
    return (
      <div className="container">
        <div className="empty-state">
          ...
          <Link href="/modules/debt-management" className="btn btn--ghost">
            ← Все декларанты
          </Link>
        </div>
      </div>
...
export default function BrokerDetailPage() {
  return (
    <ModuleGuard moduleId="debt_management">
      <BrokerDetailContent />
    </ModuleGuard>
  );
}
